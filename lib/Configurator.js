...
class Configurator {
    constructor({ schema, config, methods = {} }) {
        ...
        if (!methods.saveConfig) throw new Error('"saveConfig" function in "methods" required');
        if (!methods.validateConfig) throw new Error('"validateConfig" function in "methods" required');
    ...
    async getConfigSchema() {
        const createdSchema =  this.setConfigSchema();
    ...
    async setConfigSchema() {
        ...
        return { fields: fieldsWithFetchedOptions };
    }
}
